...
def test_user_base_valid(user_base_data):
    """Test user base schema with valid data."""
...
def test_user_create_valid(user_create_data):
    """Test user create schema with valid data."""
...
def test_user_update_valid(user_update_data):
    """Test user update schema with valid data."""
...
def test_login_request_valid(login_request_data):
    """Test login request schema with valid data."""
...
def test_user_base_nickname_valid(nickname, user_base_data):
    """Test user base schema with valid nickname."""
...
def test_user_base_nickname_invalid(nickname, user_base_data):
    """Test user base schema with invalid nickname."""
    user_base_data["nickname"] = nickname
...
def test_user_base_url_valid(url, user_base_data):
    """Test user base schema with valid profile picture URL."""
...
def test_user_base_url_invalid(url, user_base_data):
    """Test user base schema with invalid profile picture URL."""
    user_base_data["profile_picture_url"] = url
    with pytest.raises(ValidationError):
        UserBase(**user_base_data)
